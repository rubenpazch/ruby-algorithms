...
def libraryFine(d1, m1, y1, d2, m2, y2)
  ...
  if d1 <= d2 && m1 <= m2 && y1 <= y2
    ...
    return yearToPay(d1, m1, y1, d2, m2, y2)
  else 
    return 0
  end  
end
...
def monthsToPay(m1, m2, d1, d2)  
  if d1 == d2 
    ...
    return (500 * (m1 - m2 )) + ((d2 - d1) * 15 )
  else 
    return (500 * (m1 - m2 - 1)) + (((31-d2) + d1) * 15)
  end
end
...
def yearToPay(d1, m1, y1, d2, m2, y2)
  if m1 == m2 && d1 == d2 
    ...
    if d1 == d2
      return (10000 * (y1 - y2 )) + ((m1 - m2)*500)
    elsif d1 > d2
      return (10000 * (y1 - y2 )) + ((m1 - m2)*500) + ((d2 - d1) * 15 )
    else 
      return (10000 * (y1 - y2 )) + ((m1 - m2)*500) + (((31-d2) + d1) * 15)
    end
  elsif m1 < m2
    if d1 == d2
      return (10000 * (y1 - y2 - 1)) + (((12-m2)+ m1) *500) 
    elsif d1 > d2
      return (10000 * (y1 - y2 - 1)) + (((12-m2)+ m1) *500) + ((d2 - d1) * 15 )
    else 
      return (10000 * (y1 - y2 - 1)) + (((12-m2)+ m1) *500) + (((31-d2) + d1) * 15)
    end
  else
    return (10000 * (y1 - y2)) 
  end 
